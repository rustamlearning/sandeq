      ...
      <div className="flex gap-2 mb-6">
        {(['atrisk', 'heatmap', 'engagement'] as const).map(t => (
          <button key={t} onClick={() => setTab(t)}
            className={`px-4 py-2 rounded-xl text-sm font-medium transition ${tab === t ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 border border-gray-200'}`}>
              ...
              <div key={s.siswa_id} className={`bg-white rounded-2xl p-4 border ${berisiko ? 'border-red-200' : 'border-gray-100'}`}>
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-bold text-blue-600">{s.total_menit} menit</p>
