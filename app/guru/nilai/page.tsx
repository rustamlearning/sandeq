...
export default function InputNilaiPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      <PageHeader title="Input Nilai" backHref="/guru"
        actions={<Button variant="secondary" size="sm" icon={<FileText size={14}/>} onClick={() => router.push('/guru/nilai/export')}>Export Rapor</Button>}
      />
