                  ...
                  return (
                    <article key={m.id} className="surface-card overflow-hidden rounded-xl transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--shadow-lifted)]">
                      <div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-start">
                        <div className={`flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl ${isHtml ? 'bg-violet-50 text-violet-700' : 'bg-indigo-50 text-indigo-700'}`}>
                        ...
                        <div className="flex flex-shrink-0 gap-2 sm:flex-col">
                          <button onClick={() => handleEdit(m)} className="inline-flex items-center justify-center rounded-lg border border-blue-100 bg-indigo-50 px-3 py-2 text-xs font-semibold text-indigo-700 transition hover:bg-blue-100">
