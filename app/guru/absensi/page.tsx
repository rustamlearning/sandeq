...
const STATUS_CONFIG: Record<Status, { label: string; short: string; active: string; bg: string; text: string }> = {
  hadir: { label: 'Hadir',  short: 'H', active: 'bg-indigo-500 text-white', bg: 'bg-indigo-50', text: 'text-indigo-700' },
  sakit: { label: 'Sakit',  short: 'S', active: 'bg-yellow-500 text-white',  bg: 'bg-yellow-50',  text: 'text-yellow-700' },
  izin:  { label: 'Izin',   short: 'I', active: 'bg-indigo-500 text-white',    bg: 'bg-indigo-50',    text: 'text-indigo-700'   },
          ...
          <>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="p-4 border-t bg-gray-50">
                {saved && (
                  <p className="flex items-center justify-center gap-1.5 text-center text-sm text-indigo-600 font-medium mb-3">
