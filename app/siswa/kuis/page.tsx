        ...
        {kuisList.length > 0 && (
          <div className="max-w-2xl mx-auto px-4 pb-4 grid grid-cols-3 gap-2">
            {[
              ...
              { label: 'Belum', value: belum, icon: '⏳' },
              { label: 'Rata-rata', value: avgSkor !== null ? avgSkor : '–', icon: '📊' },
            ].map((s) => (
        ...
        {kuisList.length === 0 ? (
          ...
          kuisList.map((k) => {
            ...
            return (
              ...
              >
                <div className={`h-1 ${k.sudah_dikerjakan ? 'bg-green-400' : isClosed ? 'bg-gray-300' : 'bg-violet-500'}`} />
                <div className="p-4">
                  ...
                  <div className="mt-3">
                    {k.sudah_dikerjakan ? (
                      ...
                      <button
                        ...
                        className="w-full py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl text-sm font-semibold hover:from-violet-700 hover:to-indigo-700 transition shadow-sm"
                      >
                        Mulai Kerjakan →
                      </button>
                    )}
