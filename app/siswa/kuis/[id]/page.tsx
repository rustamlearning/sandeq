          ...
          >
                ...
                {soal.pilihan.map((p, i) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-lg border-2 text-sm transition-all ${
                      jawaban[soal.id] === p
                        ? 'border-blue-500 bg-blue-50 text-indigo-800 font-medium'
                        : 'border-gray-200 hover:border-blue-300 hover:bg-indigo-50'
                    }`}
                  >
            ...
            {soal.tipe === 'isian' && (
              <input
                ...
                className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-indigo-400"
              />
            )}
            ...
            {soal.tipe === 'essay' && (
              <div>
                <textarea
                  ...
                  rows={5}
                  className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-indigo-400 resize-none"
                />
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-white text-base transition-all ${
              submitting
                ...
                : 'bg-blue-600 hover:bg-indigo-700 active:scale-95'
            }`}
          >
    ...
    <div className="space-y-3">
      ...
      {pasangan.map((p, i) => (
        <div key={i} className="flex items-center gap-2">
          <div className="flex-1 bg-indigo-50 border border-indigo-200 rounded-lg px-3 py-2 text-sm font-medium text-indigo-800">
            {p.kiri}
          </div>
          ...
          <div className="flex-1">
            <select
              ...
              className="w-full border-2 border-gray-200 rounded-lg px-2 py-2 text-sm focus:outline-none focus:border-indigo-400"
            >
