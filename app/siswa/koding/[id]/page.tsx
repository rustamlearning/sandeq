        ...
        {tab === 'latihan' && (
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full h-48 bg-gray-900 text-green-400 font-mono text-sm p-4 rounded-2xl border-0 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              spellCheck={false}
            />
            ...
            <div className="flex gap-2">
              <button onClick={jalankan} className="flex-1 bg-blue-600 text-white rounded-xl py-3 font-semibold text-sm">
                ▶ Jalankan
              </button>
