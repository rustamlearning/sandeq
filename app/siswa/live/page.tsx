    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl p-8 w-full max-w-sm shadow-2xl text-center">
        ...
        <input
          ...
          maxLength={6}
          placeholder="XXXXXX"
          className="w-full text-center text-3xl font-mono font-black tracking-widest border-2 border-gray-200 rounded-2xl px-4 py-4 mb-4 focus:outline-none focus:border-blue-500 uppercase"
        />
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white rounded-2xl py-4 font-bold text-lg disabled:opacity-50"
        >
